...
public class HelloWorldCalculatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // numeric buttons and operators are present in layout
        int[] btnIds = new int[] {
        ...
        findViewById(R.id.btnEquals).setOnClickListener(v -> {
            // Regardless of calculation, show Hello World
